...
MODEL_SAVE_PATH = 'model_td_0.0-15.0_doa_0.0-0.5.pt'
SCALER_X_PATH = 'scaler_x_td_0.0-15.0_doa_0.0-0.5.pkl'
SCALER_Y_PATH = 'scaler_y_td_0.0-15.0_doa_0.0-0.5.pkl'

# Optuna 최적 하이퍼파라미터 적용
D_MODEL = 128
N_LAYERS = 11
N_HEADS = 4
MAX_LR = 2.6418725799770477e-05
BATCH_SIZE = 128
DROPOUT = 0.050086860441943805
