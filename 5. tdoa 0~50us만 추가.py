...
if __name__ == '__main__':
    # 모델 로드 (경로 주의)
    CONFIG = {
        'proposed_path': 'model_td_0.0-15.0_doa_0.0-0.5.pt', 'lstm_path': 'model_lstm_td_0.0-15.0_doa_0.0-0.5.pt',
        'mlp_path': 'model_mlp_td_0.0-15.0_doa_0.0-0.5.pt', 'cnn_path': 'model_cnn_td_0.0-15.0_doa_0.0-0.5.pt',
        'scaler_x': 'scaler_x_td_0.0-15.0_doa_0.0-0.5.pkl', 'scaler_y': 'scaler_y_td_0.0-15.0_doa_0.0-0.5.pkl'
    }
    
    try:
        sx, sy = joblib.load(CONFIG['scaler_x']), joblib.load(CONFIG['scaler_y'])
        p_m = TransformerEncoderOnlyModel(25, 3, 128, 4, 11).to(DEVICE); p_m.load_state_dict(torch.load(CONFIG['proposed_path'], map_location=DEVICE))
